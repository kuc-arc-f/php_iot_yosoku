...
<!--
 ...
 -->
	...
	<tr>
		...
		<td width="70px" align="center"><h1 class="h1_now_degree"><?php echo $sNow; ?></h1>
		</td>
		<td valign="bottom"><p> degree</p></td>
	</tr>
	</table>
  </div>
  <div class="col-md-3">
	...
	<tr>
		<td><p>1 H after:</p></td>
		<td><p class="p_param" ><?php echo $yNum1; ?></p></td>
	</tr>
	<tr>
		<td><p>6 H after:</p></td>
		<td><p class="p_param"><?php echo $yNum6; ?></p></td>
	</tr>
	</table>
...
<div class="row" style="margin-top:20px;">
  <div class="col-md-12" align="center">
	<table>
	<tr>
		<td class="field_title"><h3>field <?php echo $field; ?></h3>
		</td>
	</tr>
	<tr>
		<td >
...
<div class="row" style="margin-top:20px;">
  ...
  <div class="col-md-6" align="center">
		<table class="table table-striped" cellpadding="0" cellspacing="0" style="margin:20px;">
		<thead>
		<tr>
